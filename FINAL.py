...
window.title('CHARUSAT TYPING SPEED TESTER')
...
lbl_title = tk.Label(frame_title,text='CHARUSAT TYPING SPEED TESTER',font='algerian 35 bold',bg='yellow',fg='black',relief='flat',bd=10,width=30)
